...
public class ShapefileReader implements FileReader {
    ...
    public ShapefileReader(ShpFiles shapefileFiles, boolean strict,
        ...
        try {
            ...
            LOGGER.warn("Could not open the .shx file, continuing " +
     ...
     */
    public int getCount(int count) throws IOException {
        try {
            if (channel == null)
                return -1;
            count = 0;
            ...
            throw new IOException("Problem reading shapefile record", ioe);
        }
        return count;
    }
