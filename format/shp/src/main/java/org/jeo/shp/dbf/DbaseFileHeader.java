    ...
    public void addColumn(String inFieldName, char inFieldType,
        ...
        if (tempFieldName.length() > 10) {
            ...
            if (logger.isWarnEnabled()) {
                logger.warn("FieldName " + inFieldName
        ...
        if ((inFieldType == 'C') || (inFieldType == 'c')) {
            ...
            if (inFieldLength != 8) {
                if (logger.isDebugEnabled()) {
                    logger.debug("Field Length for " + inFieldName + " set to "
            ...
            if (inDecimalCount < 0) {
                if (logger.isDebugEnabled()) {
                    logger.debug("Field Decimal Position for " + inFieldName
            ...
            if (inDecimalCount > inFieldLength - 1) {
                if (logger.isWarnEnabled()) {
                    logger.warn("Field Decimal Position for " + inFieldName
