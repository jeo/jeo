...
import io.jeo.protobuf.Feat.Field.Type;
...
public class ProtobufReader {
    ...
    public io.jeo.vector.Feature feature(io.jeo.vector.Schema schema) throws IOException {
        if (eoi()) {
            return null;
        }
    ...
    public io.jeo.vector.Schema schema() throws IOException {
        if (eoi()) {
            return null;
        }
        ...
        SchemaBuilder sb = io.jeo.vector.Schema.build(s.getName());
