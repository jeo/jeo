...
import org.jeo.shp.file.StreamLogging;
...
public class DbaseFileReader implements FileReader {
    ...
    public DbaseFileReader(final ShpFiles shapefileFiles, final boolean useMemoryMappedBuffer) throws IOException {
        this(shapefileFiles, useMemoryMappedBuffer, DEFAULT_CHARSET);
    }
