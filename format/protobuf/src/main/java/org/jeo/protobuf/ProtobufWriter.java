...
public class ProtobufWriter {
    ...
    public ProtobufWriter feature(org.jeo.feature.Feature f) throws IOException {
    ...
    public ProtobufWriter schema(org.jeo.feature.Schema schema) throws IOException {
        Schema.Builder b = Schema.newBuilder();
        b.setName(schema.getName());

        org.jeo.feature.Field geom = schema.geometry();
        if (geom != null) {
            Type gtype = null;
        ...
        for (org.jeo.feature.Field fld : schema) {
