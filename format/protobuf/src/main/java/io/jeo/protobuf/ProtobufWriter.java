...
import io.jeo.protobuf.Feat.Feature;
import io.jeo.protobuf.Feat.Feature.Builder;
import io.jeo.protobuf.Feat.Field;
import io.jeo.protobuf.Feat.Schema;
import io.jeo.protobuf.Feat.Value;
import io.jeo.protobuf.Geom.Array;
import io.jeo.protobuf.Geom.Geometry;
import io.jeo.protobuf.Geom.Geometry.Type;
import io.jeo.protobuf.Geom.LineString;
import io.jeo.protobuf.Geom.MultiLineString;
import io.jeo.protobuf.Geom.MultiPoint;
import io.jeo.protobuf.Geom.MultiPolygon;
import io.jeo.protobuf.Geom.Point;
import io.jeo.protobuf.Geom.Polygon;
...
public class ProtobufWriter implements Disposable {
    ...
    public ProtobufWriter feature(io.jeo.vector.Feature f) throws IOException {
        if (last != null) {
            last.build().writeDelimitedTo(out);
        }

        Builder b = Feature.newBuilder();
        last = b;
    ...
    public ProtobufWriter schema(io.jeo.vector.Schema schema) throws IOException {
        Schema.Builder b = Schema.newBuilder();
        b.setName(schema.name());

        for (io.jeo.vector.Field fld : schema) {
