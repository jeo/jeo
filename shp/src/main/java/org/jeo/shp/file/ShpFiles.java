...
import static org.jeo.shp.file.ShpFileType.DBF;
...
public class ShpFiles {
    ...
    private URL findExistingFile(ShpFileType shpFileType, URL value) {
        final File file = urlToFile(value);
    ...
    public boolean isWritable() {
        ...
        return urlToFile(urls.get(SHP)).canWrite()
                && urlToFile(urls.get(DBF)).canWrite();
    }
